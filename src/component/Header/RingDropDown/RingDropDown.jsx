...
function RingDropDown (props) {
  ...
  const allCount = notificationUnreadRedux.likeCount + notificationUnreadRedux.commentCount +
...
RingDropDown.propTypes = {
  notificationUnreadRedux: PropTypes.any,
  setNotificationUnreadAction: PropTypes.any
}
