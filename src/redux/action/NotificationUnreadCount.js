import {
  SET_NOTIFICATION_UNREAD_COUNT, CLEAR_NOTIFICATION_UNREAD_LIKE,
  CLEAR_NOTIFICATION_UNREAD_FOCUS, CLEAR_NOTIFICATION_UNREAD_COMMENT, DECR_NOTIFICATION_UNREAD_IM, INCR_NOTIFICATION_UNREAD_IM
} from '../Constant'
